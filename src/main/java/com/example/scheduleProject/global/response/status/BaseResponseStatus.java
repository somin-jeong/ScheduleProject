...
public enum BaseResponseStatus implements ResponseStatus {
    ...
    FAIL_USER_UPDATE_ERROR(3004, HttpStatus.INTERNAL_SERVER_ERROR.value(), "사용자 정보 수정에 실패했습니다."),
    FAIL_USER_DELETE_ERROR(3005, HttpStatus.INTERNAL_SERVER_ERROR.value(), "사용자 삭제에 실패했습니다."),
    ...
    FAIL_SCHEDULE_UPDATE_ERROR(4003, HttpStatus.INTERNAL_SERVER_ERROR.value(), "일정 수정에 실패했습니다."),
    FAIL_SCHEDULE_DELETE_ERROR(4004, HttpStatus.INTERNAL_SERVER_ERROR.value(), "일정 삭제에 실패했습니다."),
    NOT_ALLOW_UPDATE_SCHEDULE_ERROR(4005, HttpStatus.BAD_REQUEST.value(), "일정 작성자만 일정을 수정할 수 있습니다."),
    NOT_ALLOW_DELETE_SCHEDULE_ERROR(4006, HttpStatus.BAD_REQUEST.value(), "일정 작성자만 일정을 삭제할 수 있습니다."),

    /**
     * 5000: 댓글 정보 오류
     */
    NOT_EXIST_COMMENT_ERROR(5001, HttpStatus.BAD_REQUEST.value(), "댓글이 존재하지 않습니다."),
    FAIL_COMMENT_UPDATE_ERROR(5002, HttpStatus.INTERNAL_SERVER_ERROR.value(), "댓글 수정에 실패했습니다."),
    FAIL_COMMENT_DELETE_ERROR(5003, HttpStatus.INTERNAL_SERVER_ERROR.value(), "댓글 삭제에 실패했습니다."),
